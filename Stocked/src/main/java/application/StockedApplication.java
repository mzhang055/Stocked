 ...
 * up to 10 stocks that fit this description. User's also have the ability to
 ...
 * 
 * FEATURES:
 * - sophisicated recommendation system algorithm with questions that carry different weightings.
 ...
 * - due to limitiatons on API requested, i web scrapped on yahoo finance to get each day's top 25 
 * most active stocks. this is live so everytime the user logins, updated data is collected. these 25
 ...
 * - there is also validation check on the passwords
 * 
 * MAJOR SKILLS:
